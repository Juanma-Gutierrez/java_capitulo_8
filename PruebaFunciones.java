...
public class PruebaFunciones {
    public static void main(String[] args) {
        ...
        num2 = sc.nextInt();
        res = General.potencia(num1, num2);
        ...
        System.out.println("Al número  " + num1 + ", si le quitas los " + num2 + " últimos dígitos, queda: " + res);
        ...
        System.out.println("Al número  " + num1 + ", si le quitas los " + num2 + " primeros dígitos, queda: " + res);
